...
@dataclass
class CausalLMFMOutputWithPast(ModelOutput):
    """
    ...
    feature_acts: Optional[torch.FloatTensor] = None
    ...
    def forward(
        ...
        for i, decoder_layer in enumerate(self.layers):
            ...
            if self.gradient_checkpointing and self.training:
                layer_outputs, _feature_acts = self._gradient_checkpointing_func(
                ...
                layer_outputs, _feature_acts = decoder_layer(
                    hidden_states,
...
class Gemma2ForCausalLM(Gemma2PreTrainedModel):
    ...
    def forward(
        ...
        return CausalLMFMOutputWithPast(
            loss=loss,
            logits=logits,
